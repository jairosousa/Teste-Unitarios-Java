...
public class LocacaoServiceTeste {
	...
	public void deveAlugarFilme() throws Exception {
		...
		Mockito.doReturn(DataUtils.obterData(14, 1, 2020)).when(service).obterData();
		...
		error.checkThat(isMesmaData(locacao.getDataLocacao(), obterData(14, 1, 2020)), is(true));
		error.checkThat(isMesmaData(locacao.getDataRetorno(), DataUtils.obterData(15, 1, 2020)), is(true));
